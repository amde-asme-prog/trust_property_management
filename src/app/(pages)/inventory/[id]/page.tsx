...
import { ArrowLeft, Calendar, CheckCircle, Download, FileText, Info, MapPin, XCircle } from "lucide-react"
...
const equipmentData = [
  {
    ...
    maintenance: [
      { date: "2023-01-15", type: "Routine Inspection", notes: "All systems functioning properly" },
      { date: "2023-03-22", type: "Oil Change", notes: "Replaced oil and filters" },
      { date: "2023-06-10", type: "Major Service", notes: "Replaced fuel filters and checked all connections" },
    ],
    available: true,
    images: [
...
export default function EquipmentDetailPage({ params }: { params: { id: string } }) {
  ...
  const equipment = equipmentData.find((item) => item.id === Number.parseInt(params.id))
    ...
    return (
      <div className="flex flex-col min-h-screen items-center justify-center p-4">
        <div className="text-center space-y-4">
          ...
          <p className="text-slate-500">The equipment you're looking for doesn't exist or has been removed.</p>
          <Button asChild>
            <Link href="/inventory">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="space-y-4">
              <div className="relative aspect-video overflow-hidden rounded-lg border">
                ...
                />
                <div
                  className={`absolute top-4 right-4 px-3 py-1 text-sm font-medium rounded-full ${equipment.available ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                >
              ...
              <div className="flex space-x-2 overflow-x-auto pb-2">
                {equipment.images.map((image, index) => (
                  <button
                    key={index}
                    className={`relative aspect-video w-24 md:w-32 flex-shrink-0 overflow-hidden rounded-md border ${index === activeImage ? "ring-2 ring-slate-900" : ""}`}
              ...
              <div className="pt-4 space-y-4">
                {equipment.available ? (
                  <>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-green-600">$75/day</p>
                      </div>
                  ...
                  <div className="text-center p-4 border rounded-lg bg-red-50">
                    <Badge className="bg-red-100 text-red-800 mb-2">Currently Unavailable</Badge>
                    <p className="text-slate-600">This equipment is currently unavailable for rent.</p>
                ...
                <div className="text-sm text-slate-500">
                  Contact us for long-term rental discounts and availability details.
                </div>
              </div>
            </div>
          </div>
            ...
            <Tabs defaultValue="details">
              ...
              <TabsContent value="details" className="pt-6">
                <Card>
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <h3 className="text-xl font-semibold">Full Specifications</h3>
              ...
              <TabsContent value="maintenance" className="pt-6">
                <Card>
                  <CardContent className="p-6">
                    <div className="space-y-4">
                      <h3 className="text-xl font-semibold">Maintenance History</h3>
                      <div className="space-y-4">
